...
//         // Get the date range from query params (if provided)
//         const startDate = req.query.startDate || '';
//         const endDate = req.query.endDate || '';

//         // Use 'let' instead of 'const' to modify the query strings
//         let query = `SELECT * FROM games g WHERE 1=1`;
//         const queryParams = [];
...
//         if (startDate) {
//             totalQuery += ` AND g.release_date_year >= ?`;
//             totalQueryParams.push(startDate);
//         }

//         if (endDate) {
//             totalQuery += ` AND g.release_date_year <= ?`;
//             totalQueryParams.push(endDate);
//         }
...
//         // Render the view with filtered games, currentPage, and totalPages
//         res.render('index', {
//             games,
//             currentPage,
//             totalPages,
